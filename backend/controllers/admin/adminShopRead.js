...
exports.getDashboard = async (req, res, next) => {
  try {
    ...
    // Handle case when there are no orders/payments
    const totalRevenue = totalRevenueandSales.length > 0 ? totalRevenueandSales[0].totalAmount : 0;
    const totalSales = totalRevenueandSales.length > 0 ? totalRevenueandSales[0].totalSales : 0;
