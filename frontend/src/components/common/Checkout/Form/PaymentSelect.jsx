...
function PaymentSelect({ setStage, cart_items }) {
  ...
  async function onSubmit(data) {
    ...
    if (paymentType === "card" && gatewayType === "razorpay") {
      ...
      console.log("=== COD CHECKOUT INITIATED ===");
      console.log("COD AMOUNT ->", totalamount);
      console.log("Contact details:", contactFormDetails);
      console.log("Shipping address:", shippingAddressFormDetails);
      console.log("Billing address:", billingAddressFormDetails);
      ...
      try {
        ...
        console.log("COD response received:", coddata);
        
        if (coddata?.redirectUrl) {
          console.log("Redirecting to:", coddata.redirectUrl);
          window.location.replace(coddata.redirectUrl);
        } else {
          console.error("No redirect URL in COD response");
