...
// Using a reliable online avatar image
const customerImg = "https://cdn-icons-png.flaticon.com/128/3135/3135715.png";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
      ...
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full">
          <Avatar className="h-9 w-9">
            <AvatarImage src={customerImg} alt="User Avatar" />
